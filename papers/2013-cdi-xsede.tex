...
=======
  ...
  The infrastructure described herein is immediately applicable to several
  important problems, including, but not limited to, probing the chemical
  mechanisms of enzymes via quantum mechanical/molecular mechanical 
  simulations. While such an approach has long been considered as ideal, it has
  not widely been used due to difficulties in its efficient implementation. The
  work here presents the immediate possibility of its routine application
  across multiple software and hardware architectures.
>>>>>>> c2738e4ff07cd26f2617d88bd3fcd71eeefe7128
\end{abstract}
...
\emph{multi-dimensional} REMD schemes.
...
discrete unnormalized probability distribution:
\begin{equation}
...
($\beta$-cyclodextrin) to form a supramolecular complex in solution 
(Fig.\ \ref{}). In this case the dimensionless energy is:
\begin{equation}
...
potential favoring the formation of natively folded conformations, and 
...
\begin{enumerate}[I]
\item (IMPACT systems 1-2, MM) \brnote{Left for Melissa}
