...
can introduce overhead to the application. We define overhead from an 
...
Application kernel overhead can occur for example if the kernel supports 
thread-level parallelism but doesn't scale linearly with the number of 
threads. Overhead in ASyncRE captures the time  
